...
const steps = [
  ...
  {
    n: "04",
    t: "ЖД-плечо до Хоргоса + GPS",
    d: "Везём по железной дороге, вы видите груз в реальном времени и получаете SMS на каждом этапе пути.",
  },
  {
    n: "05",
...
const whyItems = [
  ...
  },
  {
    n: "06",
    t: "GPS-трекинг 24 / 7",
    d: "Видите груз в реальном времени, SMS-оповещения на каждом этапе. Личный менеджер на связи в WhatsApp.",
  },
];
