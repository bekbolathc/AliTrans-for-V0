const reviews = [
  ...
  { ini: "АР", name: "АО «Аралтуз»", role: "снабжение", text: "«Берём контейнерами сырьё из Тяньцзиня. AXG помогли выстроить регулярные отгрузки, считают честно. Документы по таможне оформляют чисто.»" },
