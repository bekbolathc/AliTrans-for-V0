const reviews = [
  ...
  { ini: "PD", name: "Pomo Design", role: "производство · TODO", text: "«Запускали новый цех — оборудование надо было привезти в окно ±5 дней. AXG собрали мультимодальную схему, привезли точно по графику. Цех запустили без простоя.»" },
  ...
  { ini: "АР", name: "АО «Аралтуз»", role: "снабжение", text: "«Берём контейнерами сырьё из Тяньцзиня. AXG помогли выстроить регулярные отгрузки, считают честно. Документы под возврат НДС оформляют чисто.»" },
  ...
  { ini: "ПО", name: "ТОО «Призма Оверсиз»", role: "e-commerce", text: "«Селлерим на Wildberries — нужна предсказуемость каждый месяц. AXG зафиксировали тариф, склад в Иу принимает товар напрямую от фабрик.»" },
];
