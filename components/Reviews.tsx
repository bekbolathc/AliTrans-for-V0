const reviews = [
  ...
  { ini: "ЖК", name: "ТОО «Жакко Караганда»", role: "производство", text: "«Крупногабаритное оборудование для линии производства. ATG подобрали маршрут, оформили документы, доставили без повреждений. Работаем дальше.»" },
